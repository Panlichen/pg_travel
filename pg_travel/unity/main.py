...
parser.add_argument('--env_simu_sigle', type=str, default='plane',
...
if __name__ == "__main__":
    if platform.system() == 'Darwin':
        env_name = "./env_simu_sigle/{}-mac".format(args.env)
    elif platform.system() == 'Linux':
        env_name = "./env_simu_sigle/{}-linux/plane-walker".format(args.env)
    elif platform.system() == 'Windows':
        env_name = "./env_simu_sigle/{}-win/Unity Environment".format(args.env)
